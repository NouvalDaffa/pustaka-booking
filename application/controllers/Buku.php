...
{ 
    ...
    $data['buku'] = $this->ModelBuku->bukuWhere(['id_kategori' => $this->uri->segment(3)])->result_array(); 
        ...
        $kategori = $this->ModelBuku->joinKategoriBuku(['judul_buku' => $this->uri->segment(3)])->result_array(); 
        ...
        if ($this->form_validation->run() == false) { 
            ...
            $this->ModelBuku->updateBuku($data, ['id_kategori' => $this->input->post('id_kategori')]); 
            redirect('buku'); 
        } 
    } 
